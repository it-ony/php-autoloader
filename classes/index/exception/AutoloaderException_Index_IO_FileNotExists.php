...
/**
 * This file defines the AutoloaderException_Index_IO_FileNotExists.
 *
 * PHP version 5
 *
...
/**
 * AutoloaderException_Index_IO_FileNotExists happens during access to an not
 * existing file.
 *
 * @category   Autoloader
 * @package    Index
...
class AutoloaderException_Index_IO_FileNotExists extends AutoloaderException_Index_IO
{
    ...
    /**
     * AutoloaderException_Index_IO_FileNotExists is constructed with a path.
     *
